...
public class MoscaOndular {
	...
	public MoscaOndular(Context context) {
		...
		try {
			...
			in_file = am.open("ondular_morrendo.png");
			...
			Log.d("MoscaOndular error mensage", e.toString());
			Log.d("MoscaOndular error mensage", "Problemas em instanciar MoscaOndular");
		}
	}
