...
public class MoscaAgulha {
	...
	public MoscaAgulha(Context context) {
		...
		try {
			...
			in_file = am.open("agulha_morrendo.png");
			...
			Log.d("MoscaAgulha error mensage", e.toString());
			Log.d("MoscaAgulha error mensage", "Problemas em instanciar MoscaAgulha");
		}
	}
